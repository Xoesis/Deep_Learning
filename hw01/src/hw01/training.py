...
from .model import NNXBasisLinearModel
...
@nnx.jit
def train_step(
    model: NNXBasisLinearModel, optimizer: nnx.Optimizer, x: jnp.ndarray, y: jnp.ndarray
):
    """Performs a single training step."""

    def loss_fn(model: NNXBasisLinearModel):
        y_hat = model(x)
